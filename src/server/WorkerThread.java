...
public class WorkerThread extends Thread
{
	...
	public void run()
	{
		Server.logger.logInfo("Worker start...");
		...
		Server.logger.logInfo("Worker end...");
		System.exit(0);
	}
	/*
	 * sendTcp ():
	...
	private void sendTcp (Socket clientSocket)
	{
		try { 
			...
			Server.logger.logError ("Problem with Communication Server: "+e.getMessage());
		}
	}
	/*
	 * sendUdp ():
